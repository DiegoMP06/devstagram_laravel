...
new class extends Component
{
    ...
    public function deleteUser(Logout $logout): void
    {
        $this->validate([
            ...
            'password.current_password' => 'La contraseña proporcionada es incorrecta.',
        ]);
...
<section class="space-y-6">
    ...
    <button 
        ...
        class="bg-red-600 hover:bg-red-700 transition-colors uppercase font-bold inline-block px-4 py-2 text-white rounded"
    >
        Eliminar Cuenta
    </button>
